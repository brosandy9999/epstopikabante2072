...
class _ResultsAnalyticsScreenState extends State<ResultsAnalyticsScreen> {
  void _openExportDialog(List<ExamAttemptRecord> records) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: SizedBox(
          width: MediaQuery.of(ctx).size.width < 500 ? MediaQuery.of(ctx).size.width * 0.92 : 500,
          child: Column(
  ...
  void _showScorecardModal(ExamAttemptRecord record) {
    showDialog(
      ...
      builder: (ctx) => Dialog(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
        child: Container(
          width: MediaQuery.of(ctx).size.width < 540 ? MediaQuery.of(ctx).size.width * 0.92 : 520,
          padding: EdgeInsets.all(MediaQuery.of(ctx).size.width < 600 ? 16 : 28),
          child: Column(
            mainAxisSize: MainAxisSize.min,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
                ...
                children: [
                    ...
                    child: isMobile
                        ? Column(
                            ...
                            children: [
                              ...
                              Text(
                                LanguageService.instance.trText(
                                  ne: "सबै विद्यार्थीहरूले दिएका UBT परीक्षाहरूको वास्तविक नतिजा र स्कोरकार्ड विवरण।",
                                  en: "Real-time results, scorecards, and performance metrics for all candidate attempts.",
                                  ko: "모든 수험생의 UBT 실전 모의고사 채점 결과 및 성적표.",
                                ),
                  ...
                  Wrap(
                    ...
                    children: [
                      _buildKpiCard(
                        ...
                        Icons.how_to_reg,
                        Colors.blue,
                        cardWidth: isVerySmall ? constraints.maxWidth : (isMobile ? (constraints.maxWidth - 12) / 2 : 230),
                      ),
                      _buildKpiCard(
                        LanguageService.instance.trText(ne: "उत्तीर्ण दर (%)", en: "Pass Rate (%)", ko: "합격률 (%)"),
                        "${passRate.toStringAsFixed(1)}%",
                        "$totalPassed " + LanguageService.instance.trText(ne: "जना सफल", en: "candidates passed", ko: "명 합격"),
                        Icons.emoji_events,
                        Colors.green,
                        cardWidth: isVerySmall ? constraints.maxWidth : (isMobile ? (constraints.maxWidth - 12) / 2 : 230),
                      ),
                      _buildKpiCard(
                        ...
                        LanguageService.instance.trText(ne: "सबैको औसत अङ्क", en: "Average score", ko: "전체 평균 득점"),
                        Icons.trending_up,
                        Colors.purple,
                        cardWidth: isVerySmall ? constraints.maxWidth : (isMobile ? (constraints.maxWidth - 12) / 2 : 230),
                      ),
                      _buildKpiCard(
                        ...
                        LanguageService.instance.trText(ne: "हालसम्मको सर्वाधिक", en: "Highest recorded score", ko: "현재까지 최고 점수"),
                        Icons.military_tech,
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  ...
                                  style: TextStyle(fontSize: isMobile ? 14 : 16, fontWeight: FontWeight.bold, color: const Color(0xFF0F172A)),
                                ),
                              ),
                            ],
                          ),
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: DropdownButton<String>(
                              ...
                              isDense: true,
                              items: [
                                DropdownMenuItem(value: 'all', child: Text(LanguageService.instance.batchText('सबै ब्याचहरू'), style: const TextStyle(fontSize: 12))),
                                DropdownMenuItem(value: '2026 Batch A (बिहानी सत्र)', child: Text(LanguageService.instance.batchText('2026 Batch A (बिहानी सत्र)'), style: const TextStyle(fontSize: 12))),
                                DropdownMenuItem(value: '2026 Batch B (दिवा सत्र)', child: Text(LanguageService.instance.batchText('2026 Batch B (दिवा सत्र)'), style: const TextStyle(fontSize: 12))),
                                DropdownMenuItem(value: '2026 Batch C (साँझ सत्र)', child: Text(LanguageService.instance.batchText('2026 Batch C (साँझ सत्र)'), style: const TextStyle(fontSize: 12))),
                                DropdownMenuItem(value: 'विशेष UBT बुटक्याम्प', child: Text(LanguageService.instance.batchText('विशेष UBT बुटक्याम्प'), style: const TextStyle(fontSize: 12))),
                              ],
                              onChanged: (val) {
                          ...
                          Container(
                            ...
                            child: DropdownButton<String>(
                              ...
                              isDense: true,
                              items: [
                                DropdownMenuItem(value: 'all', child: Text(LanguageService.instance.trText(ne: "सबै सेटहरू", en: "All Sets", ko: "전체 세트"), style: const TextStyle(fontSize: 12))),
                                ...allMockSets.map((s) => DropdownMenuItem(value: s.id, child: Text(s.title, style: const TextStyle(fontSize: 12)))),
                              ],
                              onChanged: (val) {
                          ...
                          Container(
                            ...
                            child: DropdownButton<String>(
                              ...
                              isDense: true,
                              items: [
                                DropdownMenuItem(value: 'all', child: Text(LanguageService.instance.trText(ne: "सबै नतिजा", en: "All Results", ko: "전체 결과"), style: const TextStyle(fontSize: 12))),
                                DropdownMenuItem(value: 'pass', child: Text(LanguageService.instance.trText(ne: "उत्तीर्ण मात्र (>= ५०)", en: "Passed (>= 50)", ko: "합격만 (>= 50점)"), style: const TextStyle(fontSize: 12))),
                                DropdownMenuItem(value: 'fail', child: Text(LanguageService.instance.trText(ne: "अनुत्तीर्ण मात्र (< ५०)", en: "Failed (< 50)", ko: "불합격만 (< 50점)"), style: const TextStyle(fontSize: 12))),
                              ],
                              onChanged: (val) {
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: LanguageService.instance.trText(
                                  ne: "विद्यार्थी वा दर्ता नं...",
                                  en: "Search candidate / reg no...",
                                  ko: "수험생 성명 / 수험번호...",
                                ),
                          ...
                          ElevatedButton.icon(
                            ...
                            label: Text(
                              LanguageService.instance.trText(
                                ne: "Excel / CSV (${filteredAttempts.length})",
                                en: "Export CSV (${filteredAttempts.length})",
                                ko: "CSV 다운 (${filteredAttempts.length})",
                              ),
                              style: const TextStyle(fontSize: 12),
                            ),
                          ),
                          ...
                          TextButton.icon(
                            ...
                            label: Text(LanguageService.instance.trText(ne: "रिसेट", en: "Reset", ko: "초기화"), style: const TextStyle(fontSize: 12)),
                          ),
                        ],
                      ),
                    ),
                  ...
                  if (filteredAttempts.isEmpty)
                    Container(
                      ...
                      child: Column(
                        children: [
                          Icon(Icons.folder_open, size: 44, color: Colors.grey.shade400),
                          const SizedBox(height: 10),
                          Text(
                            LanguageService.instance.trText(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Text(a.studentName, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
                                          Text(
                                            "${a.registrationNo} • ID: ${a.studentId}",
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "R: ${a.readingScore.toStringAsFixed(1)}  L: ${a.listeningScore.toStringAsFixed(1)}",
                                          style: const TextStyle(color: Colors.black54, fontSize: 11),
                                        ),
                                      ],
                                    ),
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "${a.completedAt.hour.toString().padLeft(2, '0')}:${a.completedAt.minute.toString().padLeft(2, '0')} (${a.timeSpentSeconds ~/ 60}m)",
                                    ...
                                    OutlinedButton.icon(
                                      ...
                                      label: Text(LanguageService.instance.trText(ne: "स्कोरकार्ड", en: "Scorecard", ko: "성적표"), style: const TextStyle(fontSize: 11)),
  ...
  Widget _buildKpiCard(String title, String mainValue, String sub, IconData icon, Color color, {double cardWidth = 240}) {
    return Container(
      width: cardWidth,
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 10),
          Text(title, style: TextStyle(color: Colors.grey.shade700, fontSize: 11), maxLines: 1, overflow: TextOverflow.ellipsis),
          const SizedBox(height: 4),
          Text(mainValue, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: color)),
          const SizedBox(height: 2),
          Text(sub, style: TextStyle(fontSize: 10, color: Colors.grey.shade500), maxLines: 1, overflow: TextOverflow.ellipsis),
        ],
      ),
    );
  }
